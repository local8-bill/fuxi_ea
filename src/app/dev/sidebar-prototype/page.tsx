  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white/90 p-6 shadow-sm">
      ...
      <p className="mt-3 text-sm text-slate-600">
        This route mirrors the D086C specification. Use Cmd/Ctrl + B to collapse the rail, verify local storage persistence, and ensure views/modes trigger navigation events without touching
        production scenes.
      </p>
    </div>
  );
