  ...
  return (
    <div className="px-8 py-10 max-w-6xl mx-auto">
      ...
      <section className="mb-8">
        ...
        <h1 className="text-3xl font-semibold mb-2">Tech Stack Workspace</h1>
      ...
      {/* Inputs description */}
      <section className="mb-4 border border-gray-200 rounded-2xl p-4">
      ...
      {/* Clean upload panel */}
      <section className="mb-8 border border-gray-200 rounded-2xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <p className="text-[0.65rem] tracking-[0.25em] text-gray-500 mb-1">
            UPLOAD LUCID CSV
          </p>
          <p className="text-xs text-gray-500 max-w-md">
            Upload a Lucid CSV export of your architecture diagram. We&apos;ll
            infer systems and integrations automatically and update the Digital
            Enterprise metrics.
          </p>
        </div>
        <FileUpload
      ...
      {/* Artifacts / inventory / normalization row */}
