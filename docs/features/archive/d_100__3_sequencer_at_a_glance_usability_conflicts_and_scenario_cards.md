...
#### Standard holiday blackout (default)

Sequencer should include a **default, configurable blackout window** so plans don’t accidentally schedule high-risk cutovers during peak business periods.

**Default blackout rule (MVP):**

- **No production cutovers / go-lives:** **Nov 1 → Jan 15** (yearly)
- **Allowed:** design/build/testing and non-customer-impacting prep work

**Why:** cutover risk during peak demand is a board-level “don’t be cute” constraint.

(Users can edit/add region-specific windows later.)
